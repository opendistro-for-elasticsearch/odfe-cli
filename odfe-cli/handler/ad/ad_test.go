...
import (
	...
	"encoding/json"
	"errors"
	"es-cli/odfe-cli/controller/ad/mocks"
	"es-cli/odfe-cli/entity/ad"
...
func TestHandlerCreateAnomalyDetector(t *testing.T) {
...
func TestHandlerDeleteAnomalyDetector(t *testing.T) {
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
...
func TestHandlerStartAnomalyDetector(t *testing.T) {
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
...
func TestHandlerStopAnomalyDetector(t *testing.T) {
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
...
func TestHandlerStartAnomalyDetectorByID(t *testing.T) {
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	t.Run("test start success", func(t *testing.T) {
...
func TestHandlerStopAnomalyDetectorByID(t *testing.T) {
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	t.Run("test stop success", func(t *testing.T) {
...
func TestHandlerGetAnomalyDetectorByNamePattern(t *testing.T) {
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
...
func TestHandlerGetAnomalyDetectorByID(t *testing.T) {
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
	detectorOutput := &ad.DetectorOutput{
		ID:          "detectorID",
...
func TestHandlerUpdateDetector(t *testing.T) {
	ctx := context.Background()
	mockCtrl := gomock.NewController(t)
